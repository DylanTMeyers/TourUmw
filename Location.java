...
public class Location {
    ...
    public Location(Scanner s, String n) {
        ...
        while ((s.hasNextLine())) {
            ...
            if ((!line2.equals("+++")) && (count == 0)) {
                ...
                //description = description + " " + line2;    //why did i do this? extra space not needed
                description = description + line2;
            } else {
                break;
            }
    ...
    public void rearrangeItems(String nameOfItemInQuestion, Location locInFile) {
        ...
        for (Item i : items) {    //go thru items in arraylist of items for a location
    ...
    //from original data file, should be nothing in user's backpack --> all items should originate from a location
    public void rearrangeItemsForBackpack(String nameOfItemInQuestion) {

        TourStatus tour = TourStatus.getInstance();
        //assumes there is only 1 of each item
     ...
     */
    public void addItem(Item item) {       //for setting up a campus
    ...
    public String getListOfItems() {   //for save file; items separated by strings
        String itemList = "";
